        ...
        e.exports = [
            {
                columns: [
                    [
                        "x",
                        15225408e5,1525132e5,15278112e5,15304032e5,15330816e5,15357600e5,15383520e5,15410304e5,
    ...
    function (e, t, i) {
        ...
        class v extends g {
            ...
            updateTheme(e) {
                c(this.$left, { background: e.sliderBackground }),
                    ...
                    c(this.$right.querySelector("[data-el=arrow]"), { background: e.sliderArrow }),
                    c(this.$left.querySelector("[data-el=arrow]"), { background: e.sliderArrow });
            }
            update(e) {
        ...
        class w {
            ...
            show({ top: e, left: t }, i) {
                ...
                c(this.$el, { display: "block", top: `${e - s}px`, left: `${t + a / 2}px` }),
                    this.$el.insertAdjacentHTML(
                        "afterbegin",
                        `\n      <div class="tooltip-title">${i.title}</div>\n      <ul class="tooltip-list">\n        ${i.items
                            .map((e) => `<li class="tooltip-list-item">\n            <div class="value" style="color: ${e.color}">${e.value}</div>\n            <div class="name" style="color: ${e.color}">${e.name}</div>\n          </li>`)
                            .join(" ")}\n      </ul>\n    `
                    );
            }
            hide() {
        ...
        class M {
            constructor(e) {
                if (!e.el) throw new Error('[Telegram Chart]: "el" option must be provided');
                if (!e.data) throw new Error('[Telegram Chart]: "data" option must be provided');
                (this.$el = e.el),
                    (this.data = e.data),
        ...
        i(2);
        const L = [
            new M({ el: document.getElementById("chart1"), width: 1200, height: 400, data: a(s[0]), theme: b.day, animationSpeed: 20 }),
        ];
